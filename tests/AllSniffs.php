...
namespace ChanceDigital\CodingStandards\Tests;
...
class AllSniffs {
	...
	public static function suite() {
		...
		$suite = new TestSuite( 'ChanceDigital Standards' );

		$standards_dir = dirname( __DIR__ ) . '/ChanceDigital';
		$all_details = Standards::getInstalledStandardDetails( false, $standards_dir );
		$details = $all_details['ChanceDigital'];
